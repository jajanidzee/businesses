...
const AboutWebDesign = () => {
  return (
    <div className=" bg-[#0F0F12] relative -left-[150px] w-[1440px] pl-[30px] mt-[49px] ">
      ...
      <p className="text-[#FFFFFF] font-light flex gap-[7.97px] font-[Space Grotesk] text-[20px] ml-[40%] ">
