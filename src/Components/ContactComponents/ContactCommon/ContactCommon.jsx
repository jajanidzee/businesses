  ...
  return (
    <div className="ml-[35%] mt-[201.59px]">
      <div className="flex items-end gap-[30px] ">
        <h1 className="text-[121.43px] text-[#141414] font-medium font-[Inter] leading-[80%] ">
          COMMON
        </h1>
        <p className="text-[14.4px] text-[#141414] font-medium font-[Inter] leading-[100%]   ">
          SOME QUESTIONS <br /> PEOPLE USUALLY ASK
        </p>
      </div>
      <h1 className="text-[121.43px] text-[#141414] font-medium font-[Inter] leading-[100%]">
        QUESTIONS
      </h1>
